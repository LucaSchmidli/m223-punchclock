...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    private static final String ADD_ROLE_URL = "/roles/";
    private static final String ADD_TASK_URL = "/tasks/" ;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                //.antMatchers(HttpMethod.DELETE, USER_URL).permitAll()
                //.antMatchers(HttpMethod.POST, ADD_ROLE_URL).permitAll()
                //.antMatchers(HttpMethod.GET, ADD_ROLE_URL).permitAll()
               // .antMatchers(HttpMethod.POST, ADD_TASK_URL).permitAll()
